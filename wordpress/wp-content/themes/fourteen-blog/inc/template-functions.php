 ...
 * @return array
 */
function fourteen_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'fourteen_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function fourteen_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'fourteen_blog_pingback_header' );

/**
 * fourteen_blog Excerpt Length
 *
 * @since fourteen_blog 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'fourteen_blog_excerpt_length' ) ) :
   ...
   */
  function fourteen_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'fourteen_blog_excerpt_length', 999 );
